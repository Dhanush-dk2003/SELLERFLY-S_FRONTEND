  ...
  const handleAssignTasks = async (projectId) => {
    ...
    try {
      for (const task of tasksToAssign) {
        if (!task.userEmail || !task.title) {
        setSnackbarMessage("Task title and user email are required!");
    ...
    const errorMessage =
      err.response?.data?.message || "Failed to assign tasks";
                                ...
                                <tr key={task.id || index}>
                                  ...
                                  <td>
                                    {task.isNew ? (
                                      <input
                                        className="form-control"
                                        placeholder="Enter user's official email"
